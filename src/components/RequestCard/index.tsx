...
export default function RequestCard(props: RequestCardProps) {
  return (
    <View className="flex flex-col w-full p-5 gap-6 bg-[#161E29]/70 border border-[#2B86EE]/20 rounded-2xl">
      ...
      <View className="flex flex-row items-center justify-between ">
        ...
        <View className="flex flex-row items-center gap-4">
          ...
          <TouchableOpacity
            ...
            className="flex rounded-full py-3 px-2 items-center justify-center bg-[#161E29] border-[#2B86EE]/20"
          >
