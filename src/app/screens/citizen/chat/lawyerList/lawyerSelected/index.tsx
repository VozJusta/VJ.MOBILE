...
export default function LawyerSelected() {
  return (
    <SafeAreaView style={{ flex: 1, gap: 32 }}>
      ...
      <View className="flex flex-col items-start gap-3 w-full bg-[#1152D4]/5">
        ...
        <View className="flex flex-row gap-2 justify-center p-3">
          <View className="flex items-center justify-center p-2 bg-[#1152D4]/15 rounded-lg">
            <MaterialIcons name="gavel" color={"#1152D4"} size={20} />
          </View>
      ...
      <View className="flex flex-col py-6 items-start gap-6 w-full bg-[#1152D4]/15 border border-[#FFFFFF]/10 rounded-lg">
        <View className="flex flex-row gap-1 items-center pb-4 border-b border-b-[#FFFFFF]/10">
          <MaterialIcons name="location-on" color={"#1152D4"} size={20} />
          <Text className="text-[#F1F5F9] text-[14px] font-interRegular">
            São Paulo
          </Text>
        </View>
